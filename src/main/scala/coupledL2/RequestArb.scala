...
//  val noFreeWay = Wire(Bool())
  ...
  io.dirRead_s1.bits.replacerInfo.l1dbpBypassCandidate := task_s1.bits.l1dbpBypassCandidate
  io.dirRead_s1.bits.replacerInfo.l1dbpFinalBypass := task_s1.bits.l1dbpFinalBypass
